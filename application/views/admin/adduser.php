 ...
 <!-- container --> 
  <section class="showcase">
    <div class="container">
      ...
      <form action=" <?php echo base_url('auth/actionRegister');?>" class="remember-login-frm" id="remember-login-frm" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="card border-info rounded-0">
                <div class="card-header p-0">
                    <div class="bg-login-page text-white text-center py-2">
                        <h3><i class="fas fa-user-plus"></i> Registration of user</h3>
                    </div>
                </div>
                <div class="card-body p-3">                
                    ...
                    <div class="text-center">
                        <button type="submit" id="contact-send-a" class="btn btn-info btn-block rounded-0 py-2">Register User</button>
                    </div>
