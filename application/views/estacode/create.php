...
<form method="post" action="<?php echo base_url('estacodeCreate');?>">
    <?php
    ...
    <div class="col-xs-12 col-sm-4 col-md-12">
        ...
        <div class="col-xs-12 col-sm-4 ">
            <div class="form-group">
                ...
                <input type="text" name="program_type" class="form-control">
            </div>
        </div>
        <div class="col-xs-12 col-sm-4 ">
            <div class="form-group">
                <strong>program_country</strong>
                <input type="text" name="program_country" class="form-control">
            </div>
        </div>
        <div class="col-xs-12 col-sm-4 ">
            <div class="form-group">
                <strong>long_haul</strong>
                <input type="text" name="long_haul" class="form-control">
            </div>
        </div>
        <div class="col-xs-12 col-sm-4 ">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4 col-md-12">
            <div class="form-group">
                ...
                <input type="date" name="trip_end_date" class="form-control">
            </div>
        </div>
